...
class UNetFlow(BaseUNet):
    ...
    def forward(self, x, state1, state2, state3):
        ...
        blocks.pop()
        output_dict = {'image': img_flow[:, 0:1, :, :], 'flow': img_flow[:, 1:3, :, :], 'evt_feat': blocks, 'state1': t_state_out1, 'state2': t_state_out2, 'state3': t_state_out3, 'decoder_feats':decoder_feats}
